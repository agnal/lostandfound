  ...
  if (!user) {
    return (
      <div className="bg-[#a0f1bd] min-h-screen">
        <MenuBar activeItem="Lost Item" />
        <div className="max-w-xl mx-auto mt-24 bg-white/70 backdrop-blur rounded-2xl p-10 text-center">
          <h2 className="text-2xl font-semibold text-[#2d4f20] mb-4">Please log in to report a lost item.</h2>
          <p className="text-[#2d4f20]/80 mb-6">Login to let others know what you are looking for.</p>
  ...
  return (
    <div className="bg-[#a0f1bd] w-full min-h-screen relative">
      ...
      <main className="flex flex-col items-center pt-20 pb-16 px-4">
        <h2 className="text-4xl font-semibold text-black text-center mb-12">Lost Items</h2>

        <form onSubmit={handleSubmit} className="flex flex-col items-center gap-8 w-full max-w-2xl bg-white/80 backdrop-blur rounded-2xl p-10 shadow-lg">
          ...
          <div className="w-full flex flex-col gap-3">
            ...
            <Input
              ...
              placeholder="Add details about the lost item"
              required
              className="h-12 rounded border border-black bg-white"
            />
          </div>
